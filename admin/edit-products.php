...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$stmt->bind_param("sssssssssi", $category, $subcat, $productname, $productcompany, $productprice, $productdescription, $productscharge, $productavailability, $productpricebd, $pid);
