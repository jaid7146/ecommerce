                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="#" class="delete-btn" data-id="<?php echo $row['id']; ?>" data-toggle="modal" data-target="#deleteConfirmModal">
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#confirmDelete').on('click', function() {
                    window.location.href = "subcategory.php?id=" + deleteId + "&del=delete";
                });
            });
        </script>
    </body>
