...
<html lang="en">
    <head>
        ...
        <title>ELECTRONIC STORE | Category wise Shop </title>
        <!-- Favicon-->
...
?> 
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="admin/productimages/<?php echo htmlentities($row['productImage1']);?>" width="350"  alt="<?php echo htmlentities($row['productName']);?>" />
                            <!-- Product details-->
